...
<h2 id="2">优惠券管理V2.4.2</h2>

<h3 id="2.1">优惠券列表V2.4.2</h3>
> 入参增加startTime，endTime，comment

请求方法：nggirl-web/web/admin/invitecode/listInviteCodes/2.4.2

请求URL：接口地址/nggirl-web/web/admin/invitecode/listInviteCodes/2.4.2
...
`http://localhost/nggirl-web/web/admin/invitecode/listInviteCodes/2.4.2`
...
<h3 id="2.5">导出邀请码V2.4.2</h3>

> 查询结果导出到excel中，并下载下来

请求方法：nggirl-web/web/admin/invitecode/exportCode/2.4.2

请求URL：接口地址/nggirl-web/web/admin/invitecode/exportCode/2.4.2
...
`http://localhost/nggirl-web/web/admin/invitecode/exportCode/2.4.2'
