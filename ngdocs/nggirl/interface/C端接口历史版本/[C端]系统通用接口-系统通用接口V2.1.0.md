...
* [10.图片压缩上传V1.3.2](#10)
* [11.文件上传](#11)
* [12.获取验证码-不验证手机号是否已经注册v2.1.0](#12)
...
<h2 id="12">获取验证码-不验证手机号是否已经注册v2.1.0</h2>

请求方法：nggirl/app/cli/sys/getCode

请求URL：接口地址/nggirl/app/cli/sys/getCode
...
> http://localhost/nggirl/app/cli/sys/getCode?phoneNum=18801168634&app_id=14314&nonce=uyxxd&timestamp=1427814380&sign=hEnqQoYQgMX7BTurINs5BZ8InKI9FP
