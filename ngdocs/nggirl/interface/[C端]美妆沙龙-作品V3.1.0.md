...
<h2 id="10">10.获取喜欢的人V2.5.8</h2>

请求方法：nggirl/app/cli/salon/works/listProductLover/2.5.8

请求URL：接口地址/nggirl/app/cli/salon/works/listProductLover/2.5.8
...
|参数名称	|参数含义
|---|---|
|accessToken	|[非必填]用户授权令牌
|unionProductId |[必填]产品联合编号
|productType    |[必填]产品类型 1下午茶，2上门教学，3企业教学，4年会妆
|pageNum|页数 非必须参数，默认第一页
|pageSize|每页信息数目，非必须参数，默认20

请求示例：

> http://localhost/nggirl/app/cli/works/salon/works/listProductLover/2.5.8?app_id=14316&nonce=uyxxd&timestamp=1427814380&sign=hEnqQoYQgMX7BTurINs5BZ8InKI9FP&accessToken=5db6ad15a16d3424845adb1ab8172e42066120f0&workId=1234567&page=0&num=20
